 ...
 */
#ifndef GRAPHBOLT_CUDA_COMMON_HIP_H_
#define GRAPHBOLT_CUDA_COMMON_HIP_H_
...
struct CUDAWorkspaceAllocator {
  ...
  std::unique_ptr<T, CUDAWorkspaceAllocator> AllocateStorage(
    ...
    return std::unique_ptr<T, CUDAWorkspaceAllocator>(
        reinterpret_cast<T*>(
            c10::hip::HIPCachingAllocator::raw_alloc(sizeof(T) * size)),
        *this);
  }
};
...
#endif  // GRAPHBOLT_CUDA_COMMON_HIP_H_
